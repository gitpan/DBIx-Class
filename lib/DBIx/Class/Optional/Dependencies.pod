...
Somewhere in your build-file (e.g. L<Module::Install>'s Makefile.PL):
  ...
  configure_requires 'DBIx::Class' => '0.08119';
...
=item * Hash::Merge >= 0.11

=item * Moose >= 0.98

=item * MooseX::Types >= 0.21

=item * namespace::clean >= 0.11
...
returned string would look like:
 ...
 Moose >= 0.98, MooseX::Types >= 0.21, namespace::clean (see DBIx::Class::Optional::Dependencies for details)
